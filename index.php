...
<body style="background-color:lightblue;">
    <div class="box">
        <ul>
            <?php 
 			 ...
 			 ?>
            <li><b><?php echo $data['name']; ?><b> - <?php echo $data['comment'] ?> -
                        <?php echo $com->dateFormat($data['comment_time']); ?></li>
            <?php } ?>
        </ul>
    </div><br>
    ...
    <form action="post_comment.php" method="post"><br><br><br>
        <table>
            <tr>
                <td>Your Name:</td>
                <td><input style="width: 230px;height: 30px;" type="" name="name" placeholder="Please enter your name">
                </td>
            </tr>
            <tr>
                <td>Comment:</td>
